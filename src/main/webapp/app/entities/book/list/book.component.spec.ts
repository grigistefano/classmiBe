...
describe('Book Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'f8729558-5388-49c2-b7d6-94b789537deb' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '445c6872-bdd7-4b18-bfe7-e3e0b79feccd' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.books()[0]).toEqual(expect.objectContaining({ id: 'f8729558-5388-49c2-b7d6-94b789537deb' }));
  });
