...
describe('Author Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'f5171914-f331-4410-8fa1-ec6fb0e306fe' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'c15a65c8-cf0a-4e4a-b5e1-8e1fb791e023' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.authors()[0]).toEqual(expect.objectContaining({ id: 'f5171914-f331-4410-8fa1-ec6fb0e306fe' }));
  });
