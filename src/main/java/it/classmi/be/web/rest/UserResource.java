...
import it.classmi.be.config.Constants;
import it.classmi.be.domain.User;
import it.classmi.be.repository.UserRepository;
import it.classmi.be.security.AuthoritiesConstants;
import it.classmi.be.service.MailService;
import it.classmi.be.service.UserService;
import it.classmi.be.service.dto.AdminUserDTO;
import it.classmi.be.web.rest.errors.BadRequestAlertException;
import it.classmi.be.web.rest.errors.EmailAlreadyUsedException;
import it.classmi.be.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link it.classmi.be.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
